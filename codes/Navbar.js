...
const notifications = [
  "Project PBS is completed","New task assigned to the team A",
...
<button
   className=" p-2 rounded-full hover:bg-[#0f172a] transition">
  ...
  <div className="absolute right-0 top-16 w-72 bg-[#0f172a] shadow-lg rounded-lg overflow-hidden z-50 animate-slideDown">
    ...
    <ul>
      {notifications.slice(0,1).map((note,idx) =>(
        <li 
        key={idx}
        className="px-4 py-2 hover:bg-[#1e293b] text-[#14b8a6]
